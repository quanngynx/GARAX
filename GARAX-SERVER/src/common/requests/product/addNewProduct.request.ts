...
export interface AttributeItems extends Pick<VariantValues, 'value'>, Pick<VariantKeys, 'key'> {}

export interface VariantItems extends Pick<VariantKeys, 'key'> {
  values: string[];
}

export interface VariantValueItems extends Pick<ProductVariantValues, 'price' | 'oldPrice' | 'stock'> {
