...
export type SpecificationDetailProductCreationAttributes = Optional<SpecificationDetailProduct, 'id'>;

export class SpecificationDetailProductModel extends Model<
