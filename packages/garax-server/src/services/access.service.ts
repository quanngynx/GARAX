...
export class AccessService {
  static async handleRefreshToken({
    ...
    if (!isFoundUser) throw new AuthFailureError('User is not registered!');
    ...
    await keyStore.update(
      {
        ...
        refreshTokenUsed: Sequelize.fn('array_append', Sequelize.col('refreshTokensUsed'), refreshToken)
      },
      {
