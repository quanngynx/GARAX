...
import { Flex, Input, Tabs, TabsProps, Typography } from "antd";
            ...
            <div>
                <form>
                    <Flex vertical gap={16}>
                        <div>
                            <label className="text-black">Tên sản phẩm</label>
                            <Input
                                count={{
                                    show: true,
                                    max: 10,
                        ...
                        <div>
                            <label className="text-black">Danh mục</label>
                            <Input
                                count={{
                                    show: true,
                                    max: 10,
                        ...
                        <div>
                            <label className="text-black">Giá cơ bản</label>
                            <Input
                                count={{
                                    show: true,
                                    max: 10,
                        ...
                        <div>
                            <label className="text-black">Giá khuyến mại</label>
