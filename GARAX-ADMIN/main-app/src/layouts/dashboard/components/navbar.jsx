                ...
                <div className="w-50% h-[118px] flex justify-between pt-9">
                    <div className="w-50% h-[50px] ">
                            <label className=" h-[30px] flex justify-between border border-black rounded-xl mr-3">
                                ...
                                <input type="text" placeholder="Type here . . ." className="rounded-xl outline-none w-full bg-white" />
                            </label>
                    </div>
...
function XuLy2(){
    ...
    return (
        <Breadcrumbs maxItems={10} aria-label="breadcrumb">
            ...
            {currentPath === "/statics" ? (
                <Typography sx={{ color: 'text.primary', fontWeight: 'bold' }}>DashBoard</Typography>
            ) : (
            ...
            {currentPath === "/setting" ? (
                ...
                {currentPath === "/orders" ? (
                <Typography sx={{ color: 'text.primary', fontWeight: 'bold', }}>List Orders</Typography>
            ) : (
                ...
                <Typography sx={{ color: 'text.primary', fontWeight: 'bold', }}>List Booking</Typography>
            ) : (
                ...
                {currentPath === "/profile" ? (
                <Typography sx={{ color: 'text.primary', fontWeight: 'bold', }}>User Details</Typography>
            ) : (
