...
function Sidebar() {
  ...
  return (
    <div className="w-[300px] text-[#000000] sm:p-3">
      ...
      <div id="default-sidebar" aria-label="Sidebar" className="hidden sm:block fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0">
...
function MenuButtonDropdown({ icon, label }) {
  ...
  const handleClick = () => {
    setClicked(!isClicked); // Đổi trạng thái giữa true và false
    setIsOpen(!isOpen);
  };
  return (
    <button
