import AppTiny from '../../../assets/App-tiny.svg?react'
function administrationPanel() {
  ...
  return (
    <div className="w-full">
      <div className="text-[#212121] text-[32px] font-semibold font-['Roboto'] leading-normal mt-6 mb-2">
        Công cụ quản trị
      </div>
      ...
      <div className="text-[#212121] text-[32px] font-semibold font-['Roboto'] leading-normal mt-4 mb-4">
        {ListFeat.map((i, index) => (
            <div key={index} className='inline-flex items-center mr-4'>
                ...
                <div className="text-black text-lg font-medium font-['Inter'] leading-[18px]">{i.name}</div>
            </div>
        ))}
      </div>
    </div>
