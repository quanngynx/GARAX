...
function SidebarCustom({ collapsed }: ISidebarCustom) {
    ...
    const handlePropsCollapsed = (paramAfter: CSSProperties, paramBefore: CSSProperties) => {
        return collapsed? paramAfter : paramBefore;
    }
    ...
    const items: MenuItem[] = [
        {
            ...
            label: (
                ...
                style={handlePropsCollapsed({transform: 'translateY(8px)'}, {transform: 'translateY(0px)'})}
                >
                    ...
                    style={handlePropsCollapsed({display: 'none'}, {display: 'flex'})}
                    >
                        <NameBrandIcon />
                    </div>
                </header>
