...
export const BASE_PRODUCT_LIST = `${BASE(ver_API, ROUTES_PRODUCT)}`;
export const BASE_PRODUCT_VIEWEST = `${BASE(ver_API, ROUTES_PRODUCT)}/viewest`;
export const BASE_PRODUCT_DETAIL = BASE_PRODUCT_LIST;

export const BASE_PRODUCT_VARIANT_DETAIL = `${BASE(ver_API, ROUTES_PRODUCT)}`;
